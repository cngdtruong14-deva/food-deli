      ...
      <div className="sidebar-options">
        ...
        <div className="sidebar-group">
          ...
          <NavLink to='analytics' className="sidebar-option">
            ...
            <span className="option-text">Phân tích</span>
          </NavLink>
        </div>
        ...
        <div className="sidebar-group">
          ...
          <NavLink to='reviews' className="sidebar-option">
            ...
            <span className="option-text">Đánh giá</span>
          </NavLink>
          ...
          <NavLink to='kitchen' className="sidebar-option">
            ...
            <span className="option-text">Bếp (KDS)</span>
          </NavLink>
        </div>
        ...
        <div className="sidebar-group">
          ...
          <NavLink to='import' className="sidebar-option">
            ...
            <span className="option-text">Nhập hàng</span>
          </NavLink>
        </div>
